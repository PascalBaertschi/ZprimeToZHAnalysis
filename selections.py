...
selection = {
   ...
   "mmbb" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR >2 && isHtobb",
   #bb in sideband
   ...
   "mmbbSB" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2 && isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   #bb in signal range
   ...
   "mmbbSR" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2 && isHtobb && (H_mass>105. && H_mass<135.)",
   ...
   "mm0b" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2 && !isHtobb",
   #0b in sideband
   ...
   "mm0bSB" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2 && !isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.) ",
   #0b in signal range
   ...
   "mm0bSR" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2 && !isHtobb && (H_mass>105. && H_mass<135.)",
   ...
   "mminc" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2",
   #inclusive sideband
   ...
   "mmincSB" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR >2 && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   ...
   "mmincSR" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && DEta<1.7 && X_mass > 750 && VH_deltaR > 2 && (H_mass>105. && H_mass<135.)",
   ...
   ###  VBF  ###
   #bb
   "nnbbVBF" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && abs(H_eta)<1.1 && (V_pt/H_pt)>0.6 && X_mass > 750 && !isMaxBTag_loose && isHtobb",
   "eebbVBF" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR > 2 && isHtobb",
   "mmbbVBF" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && isHtobb", 
   #bb in sideband
   "nnbbVBFSB" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && abs(H_eta)<1.1 && (V_pt/H_pt)>0.6 && X_mass > 750 && !isMaxBTag_loose && isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   "eebbVBFSB" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR > 2 && isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   "mmbbVBFSB" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   #bb in signal range
   "nnbbVBFSR" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && abs(H_eta)<1.1 && (V_pt/H_pt)>0.6 && X_mass > 750 && !isMaxBTag_loose && isHtobb  && (H_mass>105. && H_mass<135.)",
   "eebbVBFSR" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR > 2  && isHtobb && (H_mass>105. && H_mass<135.)",
   "mmbbVBFSR" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && isHtobb && (H_mass>105. && H_mass<135.)",

   ### no btag channel
   "nn0bVBF" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && abs(H_eta)<1.1 && (V_pt/H_pt)>0.6 && X_mass > 750 && !isMaxBTag_loose && !isHtobb",
   "ee0bVBF" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR > 2 && !isHtobb",
   "mm0bVBF" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && !isHtobb",
   #0b in sideband
   "nn0bVBFSB" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && abs(H_eta)<1.1 && (V_pt/H_pt)>0.6 && X_mass > 750 && !isMaxBTag_loose && !isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   "ee0bVBFSB" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR > 2 && !isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   "mm0bVBFSB" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && !isHtobb && ((H_mass>30. && H_mass<105.) || H_mass>135.) ",   #0b in signal range
   "nn0bVBFSR" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && abs(H_eta)<1.1 && (V_pt/H_pt)>0.6 && X_mass > 750  && !isMaxBTag_loose && !isHtobb && (H_mass>105. && H_mass<135.)",
   "ee0bVBFSR" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR > 2 && !isHtobb && (H_mass>105. && H_mass<135.)",
   "mm0bVBFSR" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && !isHtobb && (H_mass>105. && H_mass<135.)",
 
   #inclusive
   #"nnincVBF" : "isZtoNN && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && (V_pt/H_pt)>0.6 && X_mass > 750",
   #"eeincVBF" : "isZtoEE && X_mass > 750 && VH_deltaR > 2",
   #"mmincVBF" : "isZtoMM && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2",
   ...
   "mmincVBF" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2",
   #inclusive sideband
   ...
   "mmincVBFSB" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR >2 && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   #inclusive signal range
   ...
   "mmincVBFSR" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && (H_mass>105. && H_mass<135.)",
   ...
   "mmbbDEtacheck" : "isZtoMM && !isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR > 2 && isHtobb",

   "eebbVBFDEtacheck" : "isZtoEE && isVBF && X_mass > 750 && VH_deltaR >2 && isHtobb",
   "mmbbVBFDEtacheck" : "isZtoMM && isVBF && Mu1_relIso!=-1. && Mu1_relIso < 0.1 && Mu2_relIso!=-1. && Mu2_relIso < 0.1 && X_mass > 750 && VH_deltaR >2 && isHtobb",
   ...
   "mmincSB_noisocut" : "isZtoMM && !isVBF && DEta<1.7 && X_mass > 750 && VH_deltaR >2 && ((H_mass>30. && H_mass<105.) || H_mass>135.)",
   "nnbbSR_nocut" : "isZtoNN && !isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && (V_pt/H_pt)>0.6  && !isMaxBTag_loose && isHtobb && (H_mass>105. && H_mass<135.)",
   "eebbSR_nocut" : "isZtoEE && !isVBF && DEta<1.7 && VH_deltaR > 2  && isHtobb && (H_mass>105. && H_mass<135.)",
   "nnbbVBFSR_nocut" : "isZtoNN && isVBF && MinDPhi>0.5 && DPhi>2 && H_chf>0.1 && (V_pt/H_pt)>0.6 && !isMaxBTag_loose && isHtobb  && (H_mass>105. && H_mass<135.)",
   "eebbVBFSR_nocut" : "isZtoEE && isVBF && VH_deltaR > 2  && isHtobb && (H_mass>105. && H_mass<135.)",
   #ranges
